...
//go:generate sed -i'' "s/github_com_ptrvsrg_crack-hash_manager_pkg_//g" ../../../docs/docs.go
//go:generate sed -i'' "s/github_com_ptrvsrg_crack-hash_manager_pkg_//g" ../../../docs/swagger.yaml
